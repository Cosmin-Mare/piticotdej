...
export const PAGE_CONTENT_META = {
  acasa: {
    ...
    desc: "Hero, despre noi, sedii (PJ & structuri), avantaje, secțiuni și mesaj final",
    paths: ["/"],
...
export function mergePageContent(pageId, fromFirestore) {
  ...
  if (pageId === "acasa") {
    return {
      ...
      sediiHead: { ...base.sediiHead, ...fromFirestore.sediiHead },
      sedii: mergeArray(base.sedii, fromFirestore.sedii, (a, b) => ({
        ...a,
        ...b,
        items: b.items ?? a.items,
      })),
      sediiFootnote: fromFirestore.sediiFootnote ?? base.sediiFootnote,
